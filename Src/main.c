...
CUSTOM_MOTION_SENSOR_AxesRaw_t accelerationRaw;
...
#define TSBOTTOM 580
  ...
  CUSTOM_MOTION_SENSOR_GetSensitivity(CUSTOM_LIS3MDL_0, MOTION_MAGNETO, &magSensitivity);		//LIS3MDL_MAG_SENSITIVITY_FS_4GAUSS
  CUSTOM_MOTION_SENSOR_GetSensitivity(CUSTOM_LSM6DSL_0, MOTION_ACCELERO, &accelSensitivity); 	//LSM6DSL_ACC_SENSITIVITY_FS_2G
...
//y  990 , -1030
//z 1040, -990
  CUSTOM_MOTION_SENSOR_GetAxes(CUSTOM_LSM6DSL_0, MOTION_GYRO, &gyro);
